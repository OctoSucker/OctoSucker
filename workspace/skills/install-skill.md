...
1. Get skills root directory via tool `get_skills_root_dir`.
...
3. Use tool `run_command` with `work_dir` (relative to workspace) and relative file paths:
...
5. Reload skills with tool `reload_skills`.